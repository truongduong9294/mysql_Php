        ...
        <div class="row">
            <div class="col-md-9">
                <div class="card card-primary card-form">
                    <form action="registerProcess" method="POST" enctype="multipart/form-data" id="formRegister">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="full_name" name="full_name" placeholder="Enter your Fullname">
                        </div>
                        <div class="form-group">
